...
router.patch('/branch/recover', productController.recoverProductToBranch) // api/v1/products/branch/recover
router.patch('/branch/stock', productController.addBranchProductStock) // api/v1/products/branch/stock
