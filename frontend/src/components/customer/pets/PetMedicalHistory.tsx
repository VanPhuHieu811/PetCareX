...
export default function PetMedicalHistory({ pet, records, onBack, onRecordClick }: PetMedicalHistoryProps) {
    if (!pet) return null;
                ...
                <div className="flex-1">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-1">{pet.gender} • {pet.weight}kg</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                {petRecords.length > 0 ? (
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
                        ...
                        <p className="text-gray-500 text-lg font-medium mb-2">Chưa có lịch sử khám</p>
                        <p className="text-gray-400 text-sm">Thú cưng này chưa có lịch sử khám bệnh hoặc tiêm phòng</p>
                    </div>
                )}
            </div>
        </div>
