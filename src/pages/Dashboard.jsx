...
import { appointments, dashboardStats } from '../services/mockData';
                    ...
                    {apt.status === 'Chờ khám' && (
                      <button
                        onClick={(e) => {
                          e.stopPropagation();
                          if (apt.type === 'clinic') {
                            navigate(`/exam/${apt.maTC}`); // Chuyển sang trang khám bạn vừa tạo
                          } else {
                            navigate(`/vaccination/${apt.maTC}`);
                          }
                        }}
