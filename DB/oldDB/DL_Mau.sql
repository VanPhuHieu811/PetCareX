/* =========================================================
   PETCAREX - SEED DATA (FIXED & CLEAN)
   Fix: Sửa lỗi trùng CCCD và thêm lệnh xóa dữ liệu cũ
   ========================================================= */

USE db_ac329b_login; -- THAY TÊN DATABASE CỦA BẠN VÀO ĐÂY NẾU KHÁC
GO

-- 1. XÓA DỮ LIỆU CŨ THEO ĐÚNG THỨ TỰ (TRÁNH LỖI KHÓA NGOẠI)
DELETE FROM DanhGia;
DELETE FROM ChiTietHoaDon;
DELETE FROM HoaDon;
DELETE FROM DieuDong;
DELETE FROM DanhSachSP;
DELETE FROM PhieuDatDVMuaHang;
DELETE FROM DanhSachVacXin;
DELETE FROM PhieuDatDVTiemPhong;
DELETE FROM DonThuoc;
DELETE FROM PhieuDatDVKhamBenh;
DELETE FROM PhieuDatDV;
DELETE FROM ThoiGianTiemChiDinh;
DELETE FROM DangKyGoiTP;
DELETE FROM CungCapDV;
...
DELETE FROM VacXin;
DELETE FROM GoiTiemPhong;
DELETE FROM Giong;
DELETE FROM LoaiThuCung;
DELETE FROM SanPham;
DELETE FROM LoaiSP;
...
-- 2. BẮT ĐẦU INSERT LẠI TỪ ĐẦU
-- Insert CHI NHÁNH
INSERT INTO ChiNhanh
   (MaCN, TenCN, DiaChi, SDT, ThoiGianMo, ThoiGianDong)
VALUES
...
-- Insert LOẠI THÀNH VIÊN
INSERT INTO LoaiThanhVien
   (MaLoaiTV, TenLoaiTV, SoTienChiTieu, SoTienDuyTri)
VALUES
   ('LTV01', N'Cơ bản', 0, 0),
...
INSERT INTO KhuyenMai
   (MaKhuyenMai, TenKhuyenMai, PhanTramGiam)
VALUES
...
-- Insert NGƯỜI DÙNG (ĐÃ SỬA LỖI TRÙNG CCCD Ở KH005)
INSERT INTO NguoiDung
   (MaND, HoTen, Email, NgaySinh, GioiTinh, SDT, CCCD, LoaiND)
VALUES
   ...
   ('KH005', N'Khách Hàng Năm', 'kh5@gmail.com', '1990-05-05', N'Nam', '0902000005', '001095000005', N'Khách hàng'),
   -- Đã sửa CCCD thành ...950...05 để tránh trùng với ND005
...
INSERT INTO TaiKhoan
   (MaND, MatKhau, TrangThai)
VALUES
   ('ND001', 'password123', N'Hoạt động'),
   ('ND002', 'password123', N'Hoạt động'),
   ('ND003', 'password123', N'Hoạt động'),
   ('ND004', 'password123', N'Hoạt động'),
   ('ND005', 'password123', N'Hoạt động'),
   ('ND006', 'password123', N'Hoạt động'),
   ('ND007', 'password123', N'Hoạt động'),
   ('ND008', 'password123', N'Hoạt động'),
   ('ND009', 'password123', N'Hoạt động'),
   ('ND010', 'password123', N'Hoạt động'),
   ('KH001', 'khach123', N'Hoạt động'),
   ('KH002', 'khach123', N'Hoạt động'),
   ('KH003', 'khach123', N'Hoạt động'),
   ('KH004', 'khach123', N'Hoạt động'),
   ('KH005', 'khach123', N'Hoạt động'),
   ('KH006', 'khach123', N'Hoạt động'),
   ('KH007', 'khach123', N'Hoạt động'),
   ('KH008', 'khach123', N'Khóa'),
   ('KH009', 'khach123', N'Hoạt động'),
   ('KH010', 'khach123', N'Hoạt động');

-- Insert NHÂN VIÊN
INSERT INTO NhanVien
   (MaNV, NgayVaoLam, LuongCoBan, TrangThai, MaChucVu, MaCN)
VALUES
   ('ND001', '2020-01-01', 20000000, N'Đang làm', 'CV001', 'CN001'),
   ('ND002', '2021-02-01', 15000000, N'Đang làm', 'CV002', 'CN001'),
   ('ND003', '2021-03-01', 15000000, N'Đang làm', 'CV002', 'CN002'),
   ('ND004', '2021-04-01', 15000000, N'Đang làm', 'CV002', 'CN003'),
   ('ND005', '2022-01-01', 8000000, N'Đang làm', 'CV003', 'CN001'),
   ('ND006', '2022-02-01', 8000000, N'Đang làm', 'CV003', 'CN002'),
   ('ND007', '2022-03-01', 8000000, N'Đang làm', 'CV003', 'CN003'),
   ('ND008', '2023-01-01', 7000000, N'Đang làm', 'CV004', 'CN001'),
   ('ND009', '2023-02-01', 7000000, N'Đang làm', 'CV004', 'CN002'),
   ('ND010', '2023-03-01', 7000000, N'Nghỉ việc', 'CV004', 'CN003');

-- Insert KHÁCH HÀNG
INSERT INTO KhachHang
   (MaKH, LanCuoiToiCuaHang, MaLoaiTV, DiemLoyalty)
VALUES
...
-- Insert THÚ CƯNG
INSERT INTO ThuCung
   (MaTC, TenTC, MaGiong, NgaySinh, TinhTrangSucKhoe, MaKH, GioiTinh)
VALUES
...
-- Insert GÓI TIÊM PHÒNG
INSERT INTO GoiTiemPhong
   (MaGoiTP, TenGoiTP, UuDaiGiamTien, ThoiHan)
VALUES
...
-- Insert VẮC XIN
INSERT INTO VacXin
   (MaVacXin, TenVacXin, NgaySanXuat, DonViTinh, GiaVacXin)
VALUES
...
-- Insert TỒN KHO VẮC XIN CHI NHÁNH
INSERT INTO VacXin_ChiNhanh
   (MaVacXin, MaCN, TonKho)
VALUES
   ('VX001', 'CN001', 100),
   ('VX002', 'CN001', 50),
   ('VX001', 'CN002', 80),
...
-- Insert TỒN KHO SẢN PHẨM CHI NHÁNH
INSERT INTO SPCuaTungCN
   (MaSP, MaCN, SoLuongTonKho)
VALUES
   ('SP001', 'CN001', 50),
   ('SP002', 'CN001', 100),
   ('SP003', 'CN001', 200),
...
-- Insert CUNG CẤP DỊCH VỤ
INSERT INTO CungCapDV
   (MaCN, MaDV)
VALUES
   ('CN001', 'DV001'),
   ('CN001', 'DV002'),
...
-- Insert ĐĂNG KÝ GÓI TIÊM PHÒNG
INSERT INTO DangKyGoiTP
   (MaDK, MaKH, MaGoiTP, ThoiGianBD, ThoiGianKT)
VALUES
...
-- Insert THỜI GIAN TIÊM CHỈ ĐỊNH
INSERT INTO ThoiGianTiemChiDinh
   (MaDK, MaVacXin, ThangTiem, LieuLuong)
VALUES
...
INSERT INTO PhieuDatDV
   (MaPhieuDV, NgayDatDV, MaKH, MaCN, MaDV, HinhThucDat, TrangThai, LoaiDichVu)
VALUES
...
INSERT INTO PhieuDatDVKhamBenh
   (MaPhieuDV, NgayKham, MoTaTrieuChung, MoTaChuanDoan, NgayTaiKham, TongTienDonThuoc, MaTC, BacSiPhuTrach)
VALUES
...
-- Insert PHIẾU TIÊM PHÒNG
INSERT INTO PhieuDatDVTiemPhong
   (MaPhieuDV, NgayTiem, MaTC, MaDK, BacSiPhuTrach)
VALUES
   ('PDV005', '2025-01-01 08:45:00', 'TC005', NULL, 'ND002'),
   ('PDV006', '2025-01-02 09:45:00', 'TC006', 'DK005', 'ND004');

-- Insert PHIẾU MUA HÀNG
INSERT INTO PhieuDatDVMuaHang
   (MaPhieuDV, TongTien)
VALUES
   ('PDV008', 380000),
   ('PDV009', 450000),
...
INSERT INTO DonThuoc
   (MaPhieuDV, MaSP, SoLuongMua, ThanhTien)
VALUES
...
-- Insert DANH SÁCH VACXIN
INSERT INTO DanhSachVacXin
   (MaPhieuDV, MaVacXin, LieuLuong)
VALUES
   ('PDV005', 'VX007', 1),
   ('PDV006', 'VX002', 1);

-- Insert DANH SÁCH SẢN PHẨM MUA
INSERT INTO DanhSachSP
   (MaPhieuDV, MaSP, SoLuongMua)
VALUES
   ('PDV008', 'SP005', 1),
   ('PDV008', 'SP006', 1),
   ('PDV009', 'SP008', 1),
...
-- Insert ĐIỀU ĐỘNG
INSERT INTO DieuDong
   (MaCN, MaNV, NgayBD, NgayKT, MaNVDieuDong)
VALUES
...
-- Insert HÓA ĐƠN
INSERT INTO HoaDon
   (MaHoaDon, MaNVLap, MaKH, MaCN, MaKhuyenMai, NgayLap, TongTien, HinhThucThanhToan)
VALUES
   ('HD001', 'ND005', 'KH001', 'CN001', NULL, '2025-01-01 09:00:00', 850000, N'Tiền mặt'),
   ('HD002', 'ND005', 'KH001', 'CN001', 'KM001', '2025-01-01 10:00:00', 380000, N'Tiền mặt'),
   ('HD003', 'ND005', 'KH004', 'CN001', NULL, '2025-01-01 09:00:00', 220000, N'Chuyển khoản'),
   ('HD004', 'ND006', 'KH006', 'CN001', NULL, '2025-01-01 10:15:00', 380000, N'Tiền mặt'),
   ('HD005', 'ND005', 'KH007', 'CN001', 'KM003', '2025-01-01 11:15:00', 450000, N'Chuyển khoản'),
   ('HD006', 'ND006', 'KH002', 'CN002', NULL, '2025-01-05 16:30:00', 800000, N'Chuyển khoản'),
   ('HD007', 'ND007', 'KH001', 'CN001', NULL, '2025-01-06 09:00:00', 100000, N'Tiền mặt'),
   ('HD008', 'ND005', 'KH003', 'CN001', NULL, '2025-01-07 10:00:00', 200000, N'Tiền mặt'),
   ('HD009', 'ND006', 'KH005', 'CN002', NULL, '2025-01-08 11:00:00', 300000, N'Chuyển khoản'),
   ('HD010', 'ND007', 'KH008', 'CN003', NULL, '2025-01-09 12:00:00', 150000, N'Tiền mặt');

-- Insert CHI TIẾT HÓA ĐƠN
INSERT INTO ChiTietHoaDon
   (MaHoaDon, MaPhieuDV, TongTienTungDV)
VALUES
   ('HD001', 'PDV001', 850000),
   ('HD002', 'PDV002', 380000),
   ('HD003', 'PDV005', 220000),
...
-- Insert ĐÁNH GIÁ
INSERT INTO DanhGia
   (MaPhieuDV, NgayDanhGia, MaKH, DiemDanhGia, ThaiDoNhanVien, MucDoHaiLong, BinhLuan)
VALUES
